...
def test(trained_model, dataset, target, result_record):
    ...
    result_record.update({'test_score': test_score})
...
def optimiseParametersAndFeatures(dataset, target):
    ...
    for i in range(100):
        ...
        trained_model = train(training_set, training_labels, i, curr_results)
        # using 1/3 original dataset
        test(trained_model, test_set, test_labels, curr_results)
